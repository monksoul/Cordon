...
public class MinValidatorTests
{
    ...
    public void New_Invalid_Parameters() =>
        Assert.Throws<ArgumentNullException>(() => new MinValidator(null!));

    [Fact]
    public void New_ReturnOK()
    {
        var validator = new MinValidator(10);
    ...
    public void SetupConversion_ReturnOK()
    {
        ...
        var validator2 = new MinValidator(10.1);
        ...
        // var validator3 = new MinValidator((long)10);
