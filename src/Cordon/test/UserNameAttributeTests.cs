...
public class UserNameAttributeTests
{
    ...
    {
        var attributeType = typeof(UserNameAttribute);
    ...
    public void IsValid_ReturnOK()
    {
        ...
        var model2 = new TestModel { Data = "贼6" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid username.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid username.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new UserNameAttribute();
        Assert.Equal("The field data is not a valid username.", attribute.FormatErrorMessage("data"));
    }
