...
public class ValueValidatorValidationTests
{
    ...
    public void SensitiveWord_ReturnOK()
    {
        ...
        var valueValidator3 = new ValueValidator<object>().SensitiveWord(SensitiveWordSanitizerFactory.DefaultName);
        ...
        var valueValidator4 = new ValueValidator<object>().SensitiveWord(SensitiveWordSanitizerFactory.DefaultName);

        Assert.Single(valueValidator4.Validators);

        var addedValidator4 = valueValidator4._lastAddedValidator as SensitiveWordValidator;
        Assert.NotNull(addedValidator4);
        ...
        Assert.True(valueValidator4.IsValid(123456));
        Assert.False(valueValidator4.IsValid("这里包含敏感词"));
