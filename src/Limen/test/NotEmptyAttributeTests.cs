...
public class NotEmptyAttributeTests
{
    ...
    public void New_ReturnOK()
    {
        ...
        var validator = Helpers.GetValidator(attribute) as NotEmptyValidator;
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not allow empty values.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not allow empty values.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new NotEmptyAttribute();
        Assert.Equal("The field data does not allow empty values.", attribute.FormatErrorMessage("data"));
    }
