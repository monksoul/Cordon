...
public class GreaterThanOrEqualToAttributeTests
{
    ...
    {
        var attributeType = typeof(GreaterThanOrEqualToAttribute);
    ...
    public void New_ReturnOK()
    {
        ...
        var attribute2 = new GreaterThanOrEqualToAttribute((IComparable)10);
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data2 must be greater than or equal to '10.1'.", validationResults3[0].ErrorMessage);
        ...
        Assert.Equal("The field Data must be greater than or equal to '10'.", validationResults4[0].ErrorMessage);
        Assert.Equal("The field Data2 must be greater than or equal to '10.1'.", validationResults4[1].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data2 must be greater than or equal to '10.1'.",
        ...
        Assert.Equal("The field Data must be greater than or equal to '10'.", exception3.ValidationResult.ErrorMessage);
    }
    ...
    {
        [GreaterThanOrEqualTo(10)] public int Data { get; set; }
