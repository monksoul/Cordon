...
public class SensitiveWordAttributeTests
{
    ...
    public void New_ReturnOK()
    {
        ...
        var attribute2 = new SensitiveWordAttribute { DictionaryName = "attribute", ShowMatchedWords = true };
    ...
    {
        var sensitiveWordSanitizer1 =
            SensitiveWordSanitizerFactory.GetOrCreate(builder => builder.AddPath("sensitive_words.txt"));
        var sensitiveWordAttribute = new SensitiveWordAttribute();
        ...
        var sensitiveWordSanitizer2 =
            SensitiveWordSanitizerFactory.GetOrCreate("attribute", builder => builder.AddWord("敏感词"));
        var sensitiveWordAttribute2 = new SensitiveWordAttribute("attribute");
