...
public class NotNullAttributeTests
{
    ...
    {
        var attributeType = typeof(NotNullAttribute);
    ...
    public void IsValid_ReturnOK()
    {
        ...
        var model2 = new TestModel { Data = null };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not allow null values.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not allow null values.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new NotNullAttribute();
        Assert.Equal("The field data does not allow null values.", attribute.FormatErrorMessage("data"));
    }
