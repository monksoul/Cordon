...
public class TelephoneAttributeTests
{
    [Fact]
    public void Attribute_Metadata()
    {
        var attributeType = typeof(TelephoneAttribute);
    ...
    {
        var model = new TestModel { Data = "0760-88809963" };
        Assert.True(Validator.TryValidateObject(model, new ValidationContext(model), null, true));

        var model2 = new TestModel { Data = "13800138000" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid telephone.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid telephone.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new TelephoneAttribute();
        Assert.Equal("The field data is not a valid telephone.", attribute.FormatErrorMessage("data"));
    }
