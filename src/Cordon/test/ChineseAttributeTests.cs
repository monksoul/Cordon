...
public class ChineseAttributeTests
{
    [Fact]
    public void Attribute_Metadata()
    {
        var attributeType = typeof(ChineseAttribute);
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data contains invalid Chinese characters.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data contains invalid Chinese characters.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new ChineseAttribute();
        Assert.Equal("The field data contains invalid Chinese characters.", attribute.FormatErrorMessage("data"));
    }
