...
public class LessThanOrEqualToValidatorTests
{
    ...
    public void New_Invalid_Parameters() =>
        Assert.Throws<ArgumentNullException>(() => new LessThanOrEqualToValidator(null!));

    [Fact]
    public void New_ReturnOK()
    {
        var validator = new LessThanOrEqualToValidator(10);
        Assert.Equal(10, validator.CompareValue);
        Assert.Null(validator.Conversion);

        Assert.NotNull(validator._errorMessageResourceAccessor);
        Assert.Equal("The field {0} must be less than or equal to '{1}'.",
    ...
    {
        var validator = new LessThanOrEqualToValidator(new DateTime(2020, 1, 1));
        Assert.True(validator.IsValid(new DateTime(2020, 1, 1)));
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field data must be less than or equal to '10'.", validationResults.First().ErrorMessage);
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field data must be less than or equal to '10'.", exception.Message);
    ...
    {
        var validator = new LessThanOrEqualToValidator(10);
        Assert.Equal("The field data must be less than or equal to '10'.", validator.FormatErrorMessage("data"));
    }
    ...
    public void SetupConversion_ReturnOK()
    {
        ...
        var validator2 = new LessThanOrEqualToValidator(10.1);
        ...
        // var validator3 = new LessThanOrEqualToValidator((long)10);
