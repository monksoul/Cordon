...
public class ValidatorsTests
{
    ...
    public void SensitiveWord_ReturnOK()
    {
        ...
        var validator2 = Validators.SensitiveWord("Furion");
        Assert.Null(validator2.Sanitizer);
        Assert.Equal("Furion", validator2.DictionaryName);
        Assert.Null(validator2.ConfigureBuilder);
        ...
        Assert.Null(validator3.ConfigureBuilder);
        ...
        Assert.Null(validator4.ConfigureBuilder);
