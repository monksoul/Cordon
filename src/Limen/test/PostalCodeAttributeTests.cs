...
public class PostalCodeAttributeTests
{
    ...
    {
        var attributeType = typeof(PostalCodeAttribute);
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid postal code.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid postal code.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new PostalCodeAttribute();
        Assert.Equal("The field data is not a valid postal code.", attribute.FormatErrorMessage("data"));
    }
