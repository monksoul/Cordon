...
public class DomainAttributeTests
{
    ...
    {
        var attributeType = typeof(DomainAttribute);
    ...
    {
        var model = new TestModel { Data = "furion.net" };
        Assert.True(Validator.TryValidateObject(model, new ValidationContext(model), null, true));

        var model2 = new TestModel { Data = "https://furion.net" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid domain name.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid domain name.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new DomainAttribute();
        Assert.Equal("The field data is not a valid domain name.", attribute.FormatErrorMessage("data"));
    }
