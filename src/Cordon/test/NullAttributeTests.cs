...
public class NullAttributeTests
{
    ...
    {
        var attributeType = typeof(NullAttribute);
    ...
    {
        var attribute = new NullAttribute();
        Assert.Null(attribute.ErrorMessage);
        var validator = Helpers.GetValidator(attribute) as NullValidator;
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data must be null.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data must be null.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new NullAttribute();
        Assert.Equal("The field data must be null.", attribute.FormatErrorMessage("data"));
    }
