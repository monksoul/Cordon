...
public class NotNotEqualAttributeTests
{
    [Fact]
    public void Attribute_Metadata()
    {
        var attributeType = typeof(NotEqualToAttribute);
    ...
    {
        var model = new TestModel { Data = "fur" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data cannot be equal to 'furion'.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data cannot be equal to 'furion'.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new NotEqualToAttribute("furion");
        Assert.Equal("The field data cannot be equal to 'furion'.", attribute.FormatErrorMessage("data"));

        var attribute2 = new NotEqualToAttribute(null);
        Assert.Equal("The field data cannot be equal to 'null'.", attribute2.FormatErrorMessage("data"));
    }
