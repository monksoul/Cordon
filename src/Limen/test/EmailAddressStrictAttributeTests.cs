...
public class EmailAddressStrictAttributeTests
{
    [Fact]
    public void Attribute_Metadata()
    {
        var attributeType = typeof(EmailAddressStrictAttribute);
    ...
    {
        var model = new TestModel { Data = "monksoul@outlook.com" };
        Assert.True(Validator.TryValidateObject(model, new ValidationContext(model), null, true));

        var model2 = new TestModel { Data = "monksoul@qq" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The Data field is not a valid e-mail address.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The Data field is not a valid e-mail address.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new EmailAddressStrictAttribute();
        Assert.Equal("The data field is not a valid e-mail address.", attribute.FormatErrorMessage("data"));
    }

    public class TestModel
    {
        [EmailAddressStrict] public string? Data { get; set; }
    }
}