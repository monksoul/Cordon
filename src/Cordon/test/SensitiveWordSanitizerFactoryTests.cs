...
public class SensitiveWordSanitizerFactoryTests
{
    ...
    //     Assert.NotNull(sensitiveWordSanitizer);
    //     Assert.Single(SensitiveWordSanitizerFactory._instances);
    //     Assert.Equal(SensitiveWordSanitizerFactory.DefaultName,
    ...
    //     var sensitiveWordSanitizer =
    //         SensitiveWordSanitizerFactory._instances[SensitiveWordSanitizerFactory.DefaultName];
    //     Assert.NotNull(sensitiveWordSanitizer);
    //     Assert.Single(SensitiveWordSanitizerFactory._instances);
    //
    //     Assert.True(sensitiveWordSanitizer.LazyInstance.Value.Contains("这里包含敏感词吗"));
    ...
    // {
    //     Assert.Throws<ArgumentNullException>(() => SensitiveWordSanitizerFactory.ResolveFilePath(null!));
    //     Assert.Throws<ArgumentException>(() => SensitiveWordSanitizerFactory.ResolveFilePath(string.Empty));
    //     Assert.Throws<ArgumentException>(() => SensitiveWordSanitizerFactory.ResolveFilePath(" "));
    // }
    //
    // [Fact]
