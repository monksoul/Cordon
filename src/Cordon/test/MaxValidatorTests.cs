...
public class MaxValidatorTests
{
    ...
    public void New_Invalid_Parameters() =>
        Assert.Throws<ArgumentNullException>(() => new MaxValidator(null!));

    [Fact]
    public void New_ReturnOK()
    {
        var validator = new MaxValidator(10);
    ...
    {
        var validator = new MaxValidator(new DateTime(2020, 1, 1));
    ...
    public void SetupConversion_ReturnOK()
    {
        ...
        var validator2 = new MaxValidator(10.1);
        ...
        // var validator3 = new MaxValidator((long)10);
