...
public class StringContainsAttributeTests
{
    ...
    {
        var attributeType = typeof(StringContainsAttribute);
    ...
    {
        var attribute = new StringContainsAttribute("ur");
        Assert.Equal("ur", attribute.SearchValue);
        Assert.Equal(StringComparison.Ordinal, attribute.Comparison);
        Assert.Null(attribute.ErrorMessage);
        var validator = Helpers.GetValidator(attribute) as StringContainsValidator;
        Assert.NotNull(validator);
        Assert.Equal("ur", validator.SearchValue);
        Assert.Equal(StringComparison.Ordinal, validator.Comparison);

        var attribute2 = new StringContainsAttribute('i') { Comparison = StringComparison.InvariantCulture };
        ...
        var validator2 = Helpers.GetValidator(attribute2) as StringContainsValidator;
    ...
    public void IsValid_ReturnOK()
    {
        ...
        var model2 = new TestModel { Data = "FUR", Data2 = "fur" };
        ...
        var model4 = new TestModel { Data = "FUR", Data2 = "free" };
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not contain the string 'ur'.", validationResults2[0].ErrorMessage);
        ...
        Assert.Equal("The field Data2 does not contain the string 'ur'.", validationResults3[0].ErrorMessage);
        ...
        Assert.Equal("The field Data does not contain the string 'ur'.", validationResults4[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data does not contain the string 'ur'.", exception.ValidationResult.ErrorMessage);

        var model3 = new TestModel { Data = "furion", Data2 = "free" };
        var exception2 =
            Assert.Throws<ValidationException>(() =>
                Validator.ValidateObject(model3, new ValidationContext(model3), true));
        Assert.Equal("The field Data2 does not contain the string 'ur'.", exception2.ValidationResult.ErrorMessage);

        var model4 = new TestModel { Data = "FUR", Data2 = "fur" };
        var exception3 =
            Assert.Throws<ValidationException>(() =>
                Validator.ValidateObject(model4, new ValidationContext(model4), true));
        Assert.Equal("The field Data does not contain the string 'ur'.", exception3.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new StringContainsAttribute("ur");
        Assert.Equal("The field data does not contain the string 'ur'.", attribute.FormatErrorMessage("data"));
    }

    public class TestModel
    {
        [StringContains("ur")] public string? Data { get; set; }

        [StringContains("ur", Comparison = StringComparison.OrdinalIgnoreCase)]
