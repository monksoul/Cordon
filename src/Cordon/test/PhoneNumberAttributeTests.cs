...
public class PhoneNumberAttributeTests
{
    ...
    {
        var attributeType = typeof(PhoneNumberAttribute);
    ...
    public void New_ReturnOK()
    {
        ...
        var validator = Helpers.GetValidator(attribute) as PhoneNumberValidator;
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid phone number.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid phone number.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new PhoneNumberAttribute();
        Assert.Equal("The field data is not a valid phone number.", attribute.FormatErrorMessage("data"));
    }
