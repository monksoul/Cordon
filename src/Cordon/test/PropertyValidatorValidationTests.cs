...
public class PropertyValidatorValidationTests
{
    ...
    public void Composite_ReturnOK()
    {
        var propertyValidator = new ObjectValidator<ValidationModel>()
            .RuleFor(u => u.Data1)
            .Composite(u => u.NotNull().MinLength(3));

        Assert.Single(propertyValidator.Validators);

        var addedValidator = propertyValidator._lastAddedValidator as CompositeValidator<object>;
        Assert.NotNull(addedValidator);
        ...
        var addedValidator2 = propertyValidator2._lastAddedValidator as CompositeValidator<object>;
        Assert.NotNull(addedValidator2);
    ...
    public void MustIfNotNull_ReturnOK()
    {
        ...
        var propertyValidator3 = new ObjectValidator<ValidationModel>()
            .RuleFor(u => u.String1)
            .MustIfNotNull((_, ctx) => ctx.Instance != "furion");

        Assert.Single(propertyValidator3.Validators);

        var addedValidator3 =
            propertyValidator3._lastAddedValidator as MustValidator<string>;
        Assert.NotNull(addedValidator3);
    ...
    public void MustIfNotNullOrEmpty_ReturnOK()
    {
        ...
        var propertyValidator3 = new ObjectValidator<ValidationModel>()
            .RuleFor(u => u.String1)
            .MustIfNotNullOrEmpty((_, ctx) => ctx.Instance != "furion");
    ...
    public void SensitiveWord_ReturnOK()
    {
        ...
        var addedValidator = propertyValidator._lastAddedValidator as SensitiveWordValidator;
        Assert.NotNull(addedValidator);
        Assert.Null(addedValidator.Sanitizer);
        Assert.Null(addedValidator.DictionaryName);
        Assert.Null(addedValidator.ConfigureBuilder);
        Assert.False(addedValidator.ShowMatchedWords);

        Assert.True(propertyValidator.IsValid(new ValidationModel { Data1 = 123456 }));
        Assert.False(propertyValidator.IsValid(new ValidationModel { Data1 = "这里包含敏感词" }));

        var propertyValidator2 = new ObjectValidator<ValidationModel>()
            .RuleFor(u => u.Data1)
            .SensitiveWord(SensitiveWordSanitizer.Build(["敏感词"]));

        Assert.Single(propertyValidator2.Validators);

        var addedValidator2 = propertyValidator2._lastAddedValidator as SensitiveWordValidator;
        Assert.NotNull(addedValidator2);
        Assert.NotNull(addedValidator2.Sanitizer);
        Assert.Null(addedValidator2.DictionaryName);
        Assert.Null(addedValidator2.ConfigureBuilder);
        Assert.False(addedValidator2.ShowMatchedWords);

        Assert.True(propertyValidator2.IsValid(new ValidationModel { Data1 = 123456 }));
        Assert.False(propertyValidator2.IsValid(new ValidationModel { Data1 = "这里包含敏感词" }));

        var propertyValidator3 = new ObjectValidator<ValidationModel>()
            .RuleFor(u => u.Data1)
            .SensitiveWord(SensitiveWordSanitizerFactory.DefaultName);

        Assert.Single(propertyValidator3.Validators);

        var addedValidator3 = propertyValidator3._lastAddedValidator as SensitiveWordValidator;
        Assert.NotNull(addedValidator3);
        Assert.Null(addedValidator3.Sanitizer);
        Assert.Equal(SensitiveWordSanitizerFactory.DefaultName, addedValidator3.DictionaryName);
        Assert.Null(addedValidator3.ConfigureBuilder);
        Assert.False(addedValidator3.ShowMatchedWords);

        Assert.True(propertyValidator3.IsValid(new ValidationModel { Data1 = 123456 }));
        Assert.False(propertyValidator3.IsValid(new ValidationModel { Data1 = "这里包含敏感词" }));
        ...
        var addedValidator4 = propertyValidator4._lastAddedValidator as SensitiveWordValidator;
        Assert.NotNull(addedValidator4);
        Assert.Null(addedValidator4.Sanitizer);
        Assert.Equal(SensitiveWordSanitizerFactory.DefaultName, addedValidator4.DictionaryName);
        Assert.Null(addedValidator4.ConfigureBuilder);
        Assert.False(addedValidator4.ShowMatchedWords);

        Assert.True(propertyValidator4.IsValid(new ValidationModel { Data1 = 123456 }));
        Assert.False(propertyValidator4.IsValid(new ValidationModel { Data1 = "这里包含敏感词" }));
