...
public class SingleAttributeTests
{
    ...
    {
        var attributeType = typeof(SingleAttribute);
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data only allows a single item.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data only allows a single item.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new SingleAttribute();
        Assert.Equal("The field data only allows a single item.", attribute.FormatErrorMessage("data"));
    }

    public class TestModel
    {
        [Single] public List<string>? Data { get; set; }
    }
}