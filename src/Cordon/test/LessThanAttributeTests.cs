...
public class LessThanAttributeTests
{
    ...
    {
        var attributeType = typeof(LessThanAttribute);
    ...
    public void New_ReturnOK()
    {
        ...
        var attribute2 = new LessThanAttribute((IComparable)10);
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data must be less than '10'.", validationResults2[0].ErrorMessage);
        ...
        Assert.Equal("The field Data2 must be less than '10.1'.", validationResults3[0].ErrorMessage);
        ...
        Assert.Equal("The field Data must be less than '10'.", validationResults4[0].ErrorMessage);
        Assert.Equal("The field Data2 must be less than '10.1'.", validationResults4[1].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data must be less than '10'.", exception.ValidationResult.ErrorMessage);

        var model3 = new TestModel { Data = 9, Data2 = 10.2 };
        var exception2 =
            Assert.Throws<ValidationException>(() =>
                Validator.ValidateObject(model3, new ValidationContext(model3), true));
        Assert.Equal("The field Data2 must be less than '10.1'.", exception2.ValidationResult.ErrorMessage);

        var model4 = new TestModel { Data = 11, Data2 = 10.2 };
        var exception3 =
            Assert.Throws<ValidationException>(() =>
                Validator.ValidateObject(model4, new ValidationContext(model4), true));
        Assert.Equal("The field Data must be less than '10'.", exception3.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new LessThanAttribute(10);
        Assert.Equal("The field data must be less than '10'.", attribute.FormatErrorMessage("data"));
    }

    public class TestModel
    {
        [LessThan(10)] public int Data { get; set; }
