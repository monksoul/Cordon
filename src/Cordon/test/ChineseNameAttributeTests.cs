...
public class ChineseNameAttributeTests
{
    [Fact]
    public void Attribute_Metadata()
    {
        var attributeType = typeof(ChineseNameAttribute);
    ...
    {
        var attribute = new ChineseNameAttribute();
        Assert.Null(attribute.ErrorMessage);
        var validator = Helpers.GetValidator(attribute) as ChineseNameValidator;
    ...
    public void GetValidationResults_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid Chinese name.", validationResults2[0].ErrorMessage);
    }
    ...
    public void Validate_ReturnOK()
    {
        ...
        Assert.Equal("The field Data is not a valid Chinese name.", exception.ValidationResult.ErrorMessage);
    }
    ...
    {
        var attribute = new ChineseNameAttribute();
        Assert.Equal("The field data is not a valid Chinese name.", attribute.FormatErrorMessage("data"));
    }

    public class TestModel
    {
        [ChineseName] public string? Data { get; set; }
    }
}